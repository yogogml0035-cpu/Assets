...
> 主文档入口：本文保存同源文章中与 Agent 主循环、迭代预算、工具并行和任务委托相关的多 Agent 工程片段。
>
> 相关上下文工程摘录：
> - [Hermes ContextCompressor 压缩流程摘录](../上下文工程/OpenClaw%20vs%20Hermes：Hermes%20ContextCompressor%20压缩流程摘录.md)
> - [Hermes 上下文压缩与 Session 链摘录](../上下文工程/OpenClaw%20vs%20Hermes：Hermes%20上下文压缩与%20Session%20链摘录.md)
